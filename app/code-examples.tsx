...
export const CodeExamples: React.FC<Props> = ({ className }) => {
  ...
  return (
    <section className={className}>
      <SectionTitle
        title="Turning Companies Into Digital Trailblazers"
        text="We help businesses leave outdated tech behind and step confidently into the digital future. With sleek designs and the newest frameworks, your company won’t just keep up it’ll lead the way."
        align="center"
        className="relative"
      >
        ...
        <div className="mt-10">
          <div className="flex gap-6 pb-14">
            ...
            <Link key="docs" href="/docs">
              <SecondaryButton label="Take a peak" IconRight={ChevronRight} />
            </Link>
          </div>
        </div>
      </SectionTitle>
