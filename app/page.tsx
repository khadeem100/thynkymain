        ...
        <div className="container relative flex flex-col mx-auto space-y-16 md:space-y-32">
          ...
          <Section className="mt-16 md:mt-20">
            <SectionTitle
              ...
              title="Everything you need for your digital footprint"
              text="Build, monetize, analyze, and protect your footprint; our platform makes it easy, providing everything you need."
              align="center"
            />
            <AnalyticsBento />
