  ...
  return (
    <div className="relative flex flex-col items-center text-center ">
      ...
      <p className="mt-6 sm:mt-8 bg-gradient-to-br text-transparent text-balance bg-gradient-stop bg-clip-text max-w-sm sm:max-w-lg xl:max-w-4xl from-white/70 via-white/70 via-40% to-white/30 text-base md:text-lg">
        We take your ideas and turn them into sleek, modern websites 
        and apps that actually stand out. No outdated tech, no boring designs. just fresh, cutting-edge digital experiences made for today.
      </p>
      ...
      <div className="flex items-center gap-6 mt-16">
        ...
        <Link href="/docs" className="hidden sm:flex">
          <SecondaryButton IconLeft={BookOpen} label="Contact us" IconRight={ChevronRight} />
        </Link>
      </div>
    </div>
  );
